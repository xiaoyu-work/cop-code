...
impl Spinner {
    ...
    pub fn tick(
        ...
        queue!(
            ...
            Print(format!("{frame} {label} ({elapsed:.1}s)")),
            ResetColor,
            RestorePosition
        )?;
        out.flush()
    ...
    pub fn finish(
        ...
        execute!(
            ...
            Print(format!("✔ {label} ({elapsed:.1}s)\n")),
            ResetColor
        )?;
        out.flush()
    }
    ...
    /// Clear the spinner line without printing a result label.
...
impl TerminalRenderer {
    ...
    fn start_code_block(&self, code_language: &str, output: &mut String) {
        ...
        let _ = writeln!(output, "{}", label.with(self.color_theme.code_block_border));
    }
